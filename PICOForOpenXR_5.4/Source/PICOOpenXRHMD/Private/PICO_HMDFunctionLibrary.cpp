...
void UHMDFunctionLibraryPICO::PauseMRCPICO(bool Pause)
{
 ...
 bool UHMDFunctionLibraryPICO::GetAdaptivePixelDensityPICO(EAdaptiveResolutionSettingPICO Setting, float& PixelDensity)
{
	return FPICOOpenXRHMDModule::Get().GetXRPlugin().GetAdaptivePixelDensity(Setting, PixelDensity);
}
